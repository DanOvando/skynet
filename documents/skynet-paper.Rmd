...
skynet_models <- skynet_models %>%
  ...
  skynet_models %>%
    filter(data_subset == "skynet",
           test_sets == "random",
           model == "ranger") %>% 
  ggplot(aes(variables, r2_training, color = dep_var)) +
  geom_point() +
  coord_flip()
...
show plots of effort vs abundance at various spatial scales 

## GFW catch per unit effort

Show CPUE calculations 

## Predicting Effort

Bio-economic theory suggests that effort and abundance are a coupled system: Density should affect the amount and location of effort, and the amount and location of effort should affect density. 

Regression and structural approach to predicting density as a latent variable 

## Predicting Density

All GFW only to this point. 
