...
```{r voi-plot, fig.cap="Differences in R2 of tuned random forest model with effort data relative to R2 obtained from only using environmental data (negative implies worse performance than environmental data only)"}
voi_plot
```
