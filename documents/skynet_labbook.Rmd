...
So tasks to test this tomorrow are whether you can get the final predictions out of a train object (model$pred), store them, and then pass them to tidyposterior::perf_mod for model comparison. If you can do that, then seems worth going the train route for now, saves some effort. 
